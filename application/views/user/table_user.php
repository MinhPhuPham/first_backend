      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="form-group">
				<div class="row">
				<label for="name" class="col-4" style="padding-top:7px"><b> Full Name :</b></label>
				<div class="col-8">
        				<input type="text" name="txtEmployeeName" class="form-control">
        		</div>
				<label for="name" class="col-4" style="padding-top:7px"><b> User Name :</b></label>
				<div class="col-8">
        				<input type="text" name="txtEmployeeName" class="form-control">
        		</div>
				<label for="name" class="col-4" style="padding-top:7px"><b> Mobile :</b></label>
				<div class="col-8">
        				<input type="text" name="txtEmployeeName" class="form-control">
        		</div>
				</div><!--Row_modal-->
