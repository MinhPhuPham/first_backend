...
class User extends CI_Controller {
	...
	public function sell_page(){
		$data['page_title']="Sell Page";
		$this->load->view('_Layout/home/header.php', $data); // Header File
		$this->load->view('User/sell_page'); // Main File (Body)
		$this->load->view('_Layout/home/footer.php'); // Footer File
    }
    public function edit_em(){
        $data['page_title']="Edit Imfor";
		$this->load->view('_Layout/home/header.php', $data); // Header File
		$this->load->view('User/edit_employee'); // Main File (Body)
		$this->load->view('_Layout/home/footer.php'); // Footer File
    }
    public function tb_users(){
        $data['page_title']="Table user";
		$this->load->view('_Layout/home/header.php', $data); // Header File
		$this->load->view('User/table_user'); // Main File (Body)
		$this->load->view('_Layout/home/footer.php'); // Footer File
    }
    public function sell_page2(){
		$data['page_title']="Sell Page";
		$this->load->view('_Layout/home/header.php', $data); // Header File
		$this->load->view('User/sell_page2'); // Main File (Body)
		$this->load->view('_Layout/home/footer.php'); // Footer File
    }
    public function Information(){
		$data['page_title']="Product information";
		$this->load->view('_Layout/home/header.php', $data); // Header File
		$this->load->view('Product/Information'); // Main File (Body)
		$this->load->view('_Layout/home/footer.php'); // Footer File
    }
}